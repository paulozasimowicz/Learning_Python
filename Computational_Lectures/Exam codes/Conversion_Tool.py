...
def play_song(file_path):
    ...
    if current_os == "Darwin":  # macOS
        ...
        music_process = subprocess.Popen(f'start {file_path}', shell=True)
...
label_denier_number = tk.Label(app, text="Denier Number",fg="black", bg="white") # Add UI elements on top of the canvas
...
label_tex_number = tk.Label(app, text="Tex Number",fg="black", bg="white")
